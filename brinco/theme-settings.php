					...
					<div class="row">
						<div class="col-md-8 offset-md-2">
							...
							<div class="page-header">
								<div class="row">
									<div class="col-sm-12">
										<h3 class="page-title">Configurações de Tema</h3>
									</div>
								</div>
							</div>
							<!-- /Page Header -->
							...
							<form>
								<div class="form-group row">
									<label class="col-lg-3 col-form-label">Nome do WEBSITE</label>
									<div class="col-lg-9">
										<input name="website_name" class="form-control" value="Sistema Via Cad" type="text">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-lg-3 col-form-label">Logo Padrão</label>
									<div class="col-lg-7">
										<input type="file" class="form-control">
										<span class="form-text text-muted">O tamanho de imagem recomendado é 40px x 40px</span>
									</div>
									<div class="col-lg-2">
								...
								<div class="form-group row">
									...
									<div class="col-lg-7">
										<input type="file" class="form-control">
										<span class="form-text text-muted">O tamanho de imagem recomendado é 16px x 16px</span>
									</div>
									<div class="col-lg-2">
