                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Hospital Admin - ID:001</h3>
								<ul class="breadcrumb">
							...
							<div class="col-auto float-right ml-auto">
								<a href="#" class="btn add-btn" data-toggle="modal" data-target="#edit_project"><i class="fa fa-plus"></i> Editar Pedido</a>
					...
					<div class="row">
						<div class="col-lg-8 col-xl-9">
							<div class="card">
								<div class="card-body">
									<div class="project-title">
										...
										<small class="block text-ellipsis m-b-15"><span class="text-xs">2</span> <span class="text-muted">tarefas abertas, </span><span class="text-xs">5</span> <span class="text-muted">Tarefas concluidas</span></small>
									</div>
							...
							<div class="card">
								<div class="card-body">
				                    <h5 class="card-title m-b-20">Arquivos de imagem enviados</h5>
									<div class="row">
							...
							<div class="card">
								<div class="card-body">
									<h5 class="card-title m-b-20">Arquivos</h5>
									<ul class="files-list">
										<li>
											<div class="files-cont">
												...
												<div class="files-info">
													...
													<div class="file-size">Tamanho: 14.8Mb</div>
												</div>
							...
							<div class="project-task">
								<ul class="nav nav-tabs nav-tabs-top nav-justified mb-0">
									<li class="nav-item"><a class="nav-link active" href="#all_tasks" data-toggle="tab" aria-expanded="true">Todas as Tarefas</a></li>
									<li class="nav-item"><a class="nav-link" href="#pending_tasks" data-toggle="tab" aria-expanded="false">Tarefas Pendentes</a></li>
									<li class="nav-item"><a class="nav-link" href="#completed_tasks" data-toggle="tab" aria-expanded="false">Tarefas Concluidas</a></li>
								</ul>
														...
														<li class="task">
															<div class="task-container">
																...
																<span class="task-action-btn task-btn-right">
																	<span class="action-circle large" title="Atribuir">
																		<i class="material-icons">person_add</i>
																	</span>
																	<span class="action-circle large delete-btn" title="Arquivar">
						...
						<div class="col-lg-4 col-xl-3">
							<div class="card">
								<div class="card-body">
									<h6 class="card-title m-b-15">Detalhes do Pedido</h6>
									<table class="table table-striped table-border">
										<tbody>
										    	<tr>
												<td>ID:</td>
												<td class="text-right">001</td>
											</tr>
											<tr>
												<td>Custo:</td>
											...
											<tr>
												<td>Criado:</td>
												<td class="text-right">25 Feb, 2022</td>
											</tr>
											<tr>
												<td>Data Limite:</td>
											...
											<tr>
												...
												<td class="text-right">
													<div class="btn-group">
														<a href="#" class="badge badge-danger dropdown-toggle" data-toggle="dropdown">Prioridade Máxima </a>
														<div class="dropdown-menu dropdown-menu-right">
															<a class="dropdown-item" href="#"><i class="fa fa-dot-circle-o text-danger"></i> Prioridade Máxima</a>
															<a class="dropdown-item" href="#"><i class="fa fa-dot-circle-o text-primary"></i>Prioridade Normal</a>
															<a class="dropdown-item" href="#"><i class="fa fa-dot-circle-o text-success"></i> Prioridade Baixa</a>
														</div>
													</div>
												</td>
											</tr>
											<tr>
												<td>Criado por:</td>
												<td class="text-right"><a href="profile.php">Lucas</a></td>
											</tr>
											<tr>
												<td>Status:</td>
												<td class="text-right">Trabalhando</td>
											</tr>
										</tbody>
									</table>
									<p class="m-b-5">Progeresso <span class="text-success float-right">40%</span></p>
							...
							<div class="card project-user">
								<div class="card-body">
									<h6 class="card-title m-b-20">
										Usuários atribuídos
										<button type="button" class="float-right btn btn-primary btn-sm" data-toggle="modal" data-target="#assign_user"><i class="fa fa-plus"></i> Adcionar</button>
									</h6>
									<ul class="list-box">
										<li>
											<a href="profile.php">
