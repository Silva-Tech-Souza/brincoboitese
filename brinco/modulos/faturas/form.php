...
foreach ($n as $resultado) {


$id	= $resultado['id'];
if ($id_cliente == '') { $id_cliente = $resultado['id_cliente']; }
if ($tp == 'copia') {
...
{
	$vencimento		= data_eua_brasil($resultado['vencimento']);
}
$id_servico1	= $resultado['id_servico1'];
$id_servico2	= $resultado['id_servico2'];
$id_servico3	= $resultado['id_servico3'];
$id_servico4	= $resultado['id_servico4'];
$id_servico5	= $resultado['id_servico5'];
$valor1			= moeda($resultado['valor1']);
$valor2			= moeda($resultado['valor2']);
$valor3			= moeda($resultado['valor3']);
$valor4			= moeda($resultado['valor4']);
$valor5			= moeda($resultado['valor5']);
$obs			= utf8_encode($resultado['obs']); 
}
if ($id_cliente != '')
{
	$tpcli = 'edit';
